  ...
  return (
    <div style={S.page}>
      <div style={S.wrap}>
        ...
        <p style={S.p}>
          PLOS ("we", "our", "us") is a personal life planning application. This policy explains what data
        ...
        <p style={S.p}>
          PLOS uses Google Gemini or Groq (depending on configuration) to power Lumi. When you send a message
        ...
        <p style={S.p}>
          If you connect your Google account, PLOS only uses your Gmail access to send emails you
        ...
        <p style={S.p}>
          PLOS's use of Google user data complies with the{' '}
        ...
        <p style={S.p}>
          PLOS is not intended for users under 13 years of age. We do not knowingly collect data from children.
        </p>
        ...
        <p style={S.p}>
          ...
          Continued use of PLOS after changes constitutes acceptance of the updated policy.
        </p>
