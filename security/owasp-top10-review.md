...
| A05 Security Misconfiguration | Overly broad CORS, exposed headers, missing production env validation | Helmet, CORS allowlist, `x-powered-by` disabled, production `FRONTEND_URL` required | Add deployment checklist and Azure policy review | Partially implemented |
